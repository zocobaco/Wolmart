...
class WXR_Parser_SimpleXML {
	function parse( $file ) {
		...
		if ( ! $wxr_version ) {
			return new WP_Error( 'WXR_parse_error', esc_html__( 'This does not appear to be a WXR file, missing/invalid WXR version number', 'wolmart' ) );
		}
...
class WXR_Parser_Regex {
	...
	function parse( $file ) {
		...
		if ( ! $wxr_version ) {
			return new WP_Error( 'WXR_parse_error', __( 'This does not appear to be a WXR file, missing/invalid WXR version number', 'wolmart' ) );
		}
