...
$custom_class = '';
if ( ! empty( $sc['params'] ) ) {
	$custom_class = function_exists( 'wolmart_get_global_hashcode' ) ? 'wpb_custom_' . wolmart_get_global_hashcode( $atts, 'vc_section', $sc['params'] ) : '';
}
...
$css_classes = array(
	...
	$custom_class,
	! empty( $atts['sticky_allow'] ) && 'yes' == $atts['sticky_allow'] ? 'sticky-content fix-top' : '',
);
