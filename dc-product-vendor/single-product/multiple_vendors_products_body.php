	...
	foreach ( $more_product_array as $more_product ) {
		...
		<div class="row rowbody">						
			...
			<div class="rowsub">
				...
				?>
				<a href="<?php echo esc_url( get_permalink( $more_product['product_id'] ) ); ?>" class="btn btn-primary btn-rounded btn-sm" ><?php esc_html_e( 'Details', 'dc-woocommerce-multi-vendor' ); ?></a>
			</div>
