...
<form id="dokan-form-contact-seller" method="post" class="seller-form clearfix">
	...
	<ul>
		...
		<li class="dokan-form-group">
			<textarea  name="message" maxlength="1000" cols="25" rows="6" placeholder="<?php esc_attr_e( 'Type your messsage...', 'dokan-lite' ); ?>" class="dokan-form-control" required="required"></textarea>
		</li>
	</ul>
	...
	<input type="submit" name="store_message_send" value="<?php esc_attr_e( 'Send Message', 'dokan-lite' ); ?>" class="btn btn-dark btn-rounded">
</form>
