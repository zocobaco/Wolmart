		...
		<p class="form-row form-group form-row-wide">
			...
			<label style="display: inline" for="tc_agree">
				...
				printf(
					...
					sprintf( '<a target="_blank" href="%s" aria-label="' . esc_html__( 'Terms & Conditions', 'wolmart' ) . '" role="button">', esc_url( $terms_condition_url ) ),
					'&amp;',
					'</a>'
				);
				?>
...
<p class="form-row form-group user-role vendor-customer-registration">
	<input type="radio" name="role" value="customer" id="login-as-customer">
	<label class="radio" for="login-as-customer"><?php esc_html_e( 'I am a customer', 'dokan-lite' ); ?></label>
	<br>
	<input type="radio" name="role" value="seller" id="login-as-seller">
	<label class="radio" for="login-as-seller"><?php esc_html_e( 'I am a vendor', 'dokan-lite' ); ?></label>
