...
<tr class="<?php echo esc_attr( $tr_class ); ?>">
	...
	<td data-title="<?php esc_attr_e( 'Image', 'dokan-lite' ); ?>" class="column-thumb">
		<?php if ( current_user_can( 'dokan_edit_product' ) ) { ?>
			<a href="<?php echo esc_url( dokan_edit_product_url( $post->ID ) ); ?>" aria-label="<?php esc_attr_e( 'Product Thumbnail', 'wolmart' ); ?>"><?php echo wp_kses( $product->get_image( 'thumbnail' ), $img_kses ); ?></a>
		<?php } else { ?>
	...
	<td data-title="<?php esc_attr_e( 'Name', 'dokan-lite' ); ?>" class="column-primary">
		...
		<button type="button" class="toggle-row" aria-label="<?php esc_attr_e( 'Toggle Row', 'wolmart' ); ?>"></button>
	</td>
